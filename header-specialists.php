...
<div class="col ground">
    <div class="header_text">
        <p>
            Присоединяйтесь к нашей команде по всей стране<br/>
            и помогайте новаторам создавать уникальные проекты!
        </p>
        <p>
            <span class="sp3">
                JS corp. > JS corporation ><span class="sp1"> Специалистам</span>
            </span>
        </p>
    </div>
</div>